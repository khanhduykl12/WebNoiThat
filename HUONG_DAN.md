...
Backend nhận ảnh (FormData)
      │
      ▼
YOLOv8 phát hiện vùng đồ nội thất (bounding box)
      │
      ▼
...
| SQL Server | 2019+ | Express/Standard (via pyodbc) |
| pip | 22.0+ | Quản lý package |
| RAM | 8 GB | Để chạy YOLOv8 + ViT |
...
### Bước 4: Cài đặt SQL Server
1. Tải SQL Server Express hoặc Developer edition.
2. Cài đặt và bật Windows Authentication hoặc Mixed Mode.
3. Tạo cơ sở dữ liệu `noithatxin_db`.
